...
public class FileUtil {
    ...
    public static String uploadFile(MultipartFile file){
        ...
        String filePath = "D:\\Java_Study\\Java_Middle\\SpringbootDemo-10-04\\src\\main\\resources\\static\\upload\\heads\\";
        ...
        fileName = UUID.randomUUID().toString().replace("-", "").substring(0, 12) + fileName;
        //第三部：通过输出流将文件写入硬盘文件夹并关闭流
